...
//        ArrayList<Application> emptyApps = new ArrayList<>();
...
//        ArrayList<Application> singleApps = new ArrayList<>();
//        singleApps.add(app);
//
...
//
//        ArrayList<Application> unsortedApps = new ArrayList<>();
...
//        ArrayList<Application> apps = new ArrayList<>();
//        apps.add(new Application("Google", "Software Engineer", "2025-01-10"));
//        apps.add(new Application("Amazon", "Data Analyst", "2025-02-10"));
//
...
//        ArrayList<Application> apps = new ArrayList<>();
//        apps.add(new Application("Google", "Software Engineer", "2025-01-10"));
//        apps.add(new Application("GoGoTravel", "Product Manager", "2025-02-10"));
//        apps.add(new Application("Amazon", "Data Analyst", "2025-03-10"));
//
